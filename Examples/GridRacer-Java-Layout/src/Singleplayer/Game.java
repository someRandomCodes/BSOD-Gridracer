...
public class Game extends JPanel implements ActionListener{
	...
	public Game()
	{
		...
		ImageIcon icon_apple = new ImageIcon("src/assets/icons/apple.png");
		ImageIcon icon_head = new ImageIcon("src/assets/icons/head.png");
		ImageIcon icon_tail = new ImageIcon("src/assets/icons/tail.png");
